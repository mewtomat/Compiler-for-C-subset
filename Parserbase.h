...
// $insert polymorphicSpecializations
    template <>
    struct TagOf<declaration_class*>
    {
        static Tag__ const tag = Tag__::declrtn;
    };

    template <>
    struct TagOf<parameter_declaration_class*>
    {
        static Tag__ const tag = Tag__::paramdecl;
    };

    template <>
    struct TagOf<parameter_list_class*>
    {
        static Tag__ const tag = Tag__::paramlist;
    };

    template <>
    struct TagOf<abstract_astnode*>
    {
        static Tag__ const tag = Tag__::absnode;
    };

    template <>
    struct TagOf<seq_astnode*>
    {
        static Tag__ const tag = Tag__::seqnode;
    };
    ...
    {
        static Tag__ const tag = Tag__::stringconst;
    };

    template <>
    struct TagOf<funcall_astnode*>
    {
        static Tag__ const tag = Tag__::funcallnode;
    };

    template <>
    struct TagOf<declarator_class*>
    {
        static Tag__ const tag = Tag__::declrtr;
    };

    template <>
    struct TagOf<op_unary_astnode*>
    {
        static Tag__ const tag = Tag__::unaryopnode;
    };

    template <>
    struct TagOf<statement_astnode*>
    {
        static Tag__ const tag = Tag__::stmtnode;
    };

    template <>
    struct TagOf<exp_astnode*>
    {
        static Tag__ const tag = Tag__::expnode;
    };

    template <>
    struct TagOf<declaration_list_class*>
    {
        static Tag__ const tag = Tag__::decltnlist;
    };

    template <>
    struct TagOf<type_specifier_class*>
    {
        static Tag__ const tag = Tag__::typespec;
    };

    template <>
    struct TagOf<ref_astnode*>
    {
        static Tag__ const tag = Tag__::refnode;
    };

    template <>
    struct TagOf<declarator_list_class*>
    {
        static Tag__ const tag = Tag__::declrtrlist;
    };

    template <>
    struct TagOf<intconst_astnode*>
    {
        static Tag__ const tag = Tag__::intconst;
    };

    template <>
    struct TagOf<fun_declarator_class*>
    {
        static Tag__ const tag = Tag__::fundecl;
    };

    template <>
    struct TagOf<floatconst_astnode*>
    {
        static Tag__ const tag = Tag__::floatconst;
    };

    template <>
    struct TypeOfBase<Tag__::declrtn>
    {
        typedef declaration_class* DataType;
    };

    template <>
    struct TypeOfBase<Tag__::paramdecl>
    {
        typedef parameter_declaration_class* DataType;
    };

    template <>
    struct TypeOfBase<Tag__::paramlist>
    {
        typedef parameter_list_class* DataType;
    };

    template <>
    struct TypeOfBase<Tag__::absnode>
    {
        typedef abstract_astnode* DataType;
    };

    template <>
    struct TypeOfBase<Tag__::seqnode>
    {
        typedef seq_astnode* DataType;
    };
    ...
    template <>
    struct TypeOfBase<Tag__::stringconst>
    {
        typedef stringconst_astnode* DataType;
    };

    template <>
    struct TypeOfBase<Tag__::funcallnode>
    {
        typedef funcall_astnode* DataType;
    };

    template <>
    struct TypeOfBase<Tag__::declrtr>
    {
        typedef declarator_class* DataType;
    };

    template <>
    struct TypeOfBase<Tag__::unaryopnode>
    {
        typedef op_unary_astnode* DataType;
    };

    template <>
    struct TypeOfBase<Tag__::stmtnode>
    {
        typedef statement_astnode* DataType;
    };

    template <>
    struct TypeOfBase<Tag__::expnode>
    {
        typedef exp_astnode* DataType;
    };

    template <>
    struct TypeOfBase<Tag__::decltnlist>
    {
        typedef declaration_list_class* DataType;
    };

    template <>
    struct TypeOfBase<Tag__::typespec>
    {
        typedef type_specifier_class* DataType;
    };

    template <>
    struct TypeOfBase<Tag__::refnode>
    {
        typedef ref_astnode* DataType;
    };

    template <>
    struct TypeOfBase<Tag__::declrtrlist>
    {
        typedef declarator_list_class* DataType;
    };

    template <>
    struct TypeOfBase<Tag__::intconst>
    {
        typedef intconst_astnode* DataType;
    };

    template <>
    struct TypeOfBase<Tag__::fundecl>
    {
        typedef fun_declarator_class* DataType;
    };

    template <>
    struct TypeOfBase<Tag__::floatconst>
    {
        typedef floatconst_astnode* DataType;
    };
